...
test_Prime: addi  $t0, $zero, 1     # $t0 = number of divisors for $a0, 1 because number always divisible by itself
...
Loop2:      div   $a0, $t1          # 1st part of modulus
            mfhi  $t2               # $t2 = number % dividing number
...
Skip2:      sub   $t1, $t1, 1       # Decrement dividing number
  	    ...
  	    slt   $t4, $t3, $t0     # $t3 = 2, check if 2 < count, then number is evenly divisible by more than 2 numbers = not prime
